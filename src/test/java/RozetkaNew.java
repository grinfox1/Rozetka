...
public class RozetkaNew {
    ...
    @Test
    public void Premium(){
        WebElement premium = driver.findElement(By.xpath(".//*['//rz-premium//p']//*[contains(text(), 'Попробуйте')]"));
    ...
    public void cart() {
        ...
        WebElement close = driver.findElement(By.cssSelector("button.modal__close.ng-star-inserted"));
        close.click();
    }
